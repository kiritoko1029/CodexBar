...
enum CostUsageScanner {
        ...
        checkCancellation: CancellationCheck?) throws -> CostUsageDailyReport
    {
        ...
        case .openai, .azureopenai, .zai, .gemini, .antigravity, .cursor, .opencode, .opencodego, .alibaba,
             ...
             .t3chat, .synthetic, .custom, .sub2api, .openrouter, .elevenlabs, .warp, .perplexity, .mimo, .doubao,
             .abacus, .mistral, .deepseek, .codebuff, .crof, .windsurf, .venice, .commandcode, .stepfun, .bedrock,
